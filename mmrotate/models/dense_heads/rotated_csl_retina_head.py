...
class RotatedCSLRetinaHead(RotatedRetinaHead):
    ...
    def _init_layers(self):
        ...
        super(RotatedCSLRetinaHead, self)._init_layers()
    ...
    def forward_single(self, x):
        ...
        Returns:
            tuple:
                ...
                cls_score (torch.Tensor): Angle for a single scale level
    ...
    def _get_targets_single(self,
        ...
        if len(pos_inds) > 0:
            ...
            if self.use_encoded_angle:
                ...
                angle_targets[pos_inds, :] = sampling_result.pos_gt_bboxes[:,
                                                                           4:5]
    ...
    def get_bboxes(self,
        ...
        for img_id, _ in enumerate(img_metas):
            ...
            angle_cls_list = [
                angle_classes[i][img_id].detach() for i in range(num_levels)
            ]
